...
print(df_train.var().sort_values(ascending=False).head(10))

df_train = df_train[high_variance]

##print(df_train.ix[:,0:2*n+1].apply(lambda x: n-Counter(x)[0], axis=0).value_counts())
...
plt.tight_layout()
plt.savefig('reduction-variance.png',dpi=96)
